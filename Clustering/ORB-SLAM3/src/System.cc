    ...
    mbActivateLocalizationMode(false), mbDeactivateLocalizationMode(false), mbShutDown(false)
{
    ...
    cout << endl <<
    "Cuda accelerated ORB-SLAM by Filippo Muzzini, Nicola Capodieci, Roberto Cavicchioli and Benjamin Rouxel" << endl <<
    "Based on ORB-SLAM3 (Carlos Campos, Richard Elvira, Juan J. Gómez Rodríguez, José M.M. Montiel and Juan D. Tardós)" << endl  <<
